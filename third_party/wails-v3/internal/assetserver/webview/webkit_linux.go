...
func webkit_uri_scheme_request_finish(req *C.WebKitURISchemeRequest, code int, header http.Header, stream *C.GInputStream, streamLength int64) error {
	...
	// NOTE: do NOT unref hdrs here. webkit_uri_scheme_response_set_http_headers
	// takes ownership of the SoupMessageHeaders; unref-ing causes a double-free
	// (crash in libsoup soup_message_headers_* under webkit2gtk 2.52 / libsoup 3.6).
